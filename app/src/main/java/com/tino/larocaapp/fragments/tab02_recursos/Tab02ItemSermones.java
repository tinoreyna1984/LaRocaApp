 ...
 */
public class Tab02ItemSermones extends Fragment {


    public Tab02ItemSermones() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab02_item_sermones, container, false);
